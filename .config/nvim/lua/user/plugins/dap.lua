return {
	{
		...
		config = function()
			...
			vim.api.nvim_set_hl(0, "DapBreakpoint", { ctermbg = 0, bg = "#6A3E3E" })
			vim.api.nvim_set_hl(0, "DapBreakpointSymbol", { ctermbg = 0, fg = "#6A3E3E" })
			vim.api.nvim_set_hl(0, "DapLogPoint", { ctermbg = 0, bg = "#61afef" })
			vim.api.nvim_set_hl(0, "DapStopped", { ctermbg = 0, bg = "#4b6f4b" })
			vim.api.nvim_set_hl(0, "DapStoppedSymbol", { ctermbg = 0, fg = "#4b6f4b" })
